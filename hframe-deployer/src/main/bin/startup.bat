...
set CMD_STR= java %JAVA_OPTS% -classpath "%CLASSPATH%" com.hframe.deployer.webcontaner.HFrameworkBootstrap
echo start cmd : %CMD_STR%

java %JAVA_OPTS% -classpath "%CLASSPATH%" com.hframe.deployer.webcontaner.HFrameworkBootstrap