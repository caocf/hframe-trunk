...
//        return AbstractDAOSupport.find(" from "+CreatorUtil.getJavaClassName(dbObjectName)+" where  "+CreatorUtil.getJavaVarName(primaryKey)+" = '"+objectId+"'");
...
//
//        AbstractDAOSupport AbstractDAOSupport= (AbstractDAOSupport) webappcontext.getBean("abstractDAOSupport");
//        return AbstractDAOSupport.find(" from " + CreatorUtil.getJavaClassName(dbObjectName) + " where  " + condition, (pageIndex - 1) * pageSize, pageSize);
...
//        AbstractDAOSupport AbstractDAOSupport= (AbstractDAOSupport) webappcontext.getBean("abstractDAOSupport");
//
//        return AbstractDAOSupport.find(" from "+CreatorUtil.getJavaClassName(dbObjectName)+" where  "+condition ).size();
...
//        List lastList=AbstractDAOSupport.find(" from "+CreatorUtil.getJavaClassName(dbObjectName)+" where  "+condition );
...
//        for (Object object : lastList) {
//            Object parValue=ReflectUtil.invokeGetMethod(id, object, Class.forName(popath));
//            String parName=CreatorUtil.getJavaVarName(pid);
//            List tempResult=AbstractDAOSupport.find(" from "+CreatorUtil.getJavaClassName(dbObjectName)+" where  "+parName+ " = "+ parValue);
//            result.addAll(tempResult);
