package com.hframe.generator.struts2;
...
//		inputParam.put("VarName", CreatorUtil.getJavaVarName(table.getTableName()).toLowerCase());
...
//		//获取参数
//		Map<String, String> inputParam=new HashMap<String, String>();
//		inputParam.put("ClassName", CreatorUtil.getJavaClassName(coreSet.getCoreSetName()));
//		inputParam.put("VarName", CreatorUtil.getJavaVarName(coreSet.getCoreSetName()).toLowerCase());
//		inputParam.put("UserName",username);
//		inputParam.put("DbName",dbName);
//
//		//获取findAll方法
