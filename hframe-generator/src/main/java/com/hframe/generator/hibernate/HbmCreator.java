...
//
//			String xmlName=CreatorUtil.getJavaClassName(table.getTableName());
//
...
//		String poPath=xmlFileName.substring(xmlFileName.indexOf("/src/")+5,xmlFileName.lastIndexOf("/hbm/")).replace("/", ".")+CreatorUtil.getJavaClassName(table.getTableName()).toLowerCase()+".po."+CreatorUtil.getJavaClassName(table.getTableName());
...
//				idElement.setAttribute("name", CreatorUtil.getJavaVarName(column.getColumnName()));
...
//				propertyElement.setAttribute("name", CreatorUtil.getJavaVarName(column.getColumnName()));
