...
import com.hframe.generator.constants.Constant;
...
//					CreatorUtil.getJavaVarName(Column.getColumnName()));
...
//						"List<" + CreatorUtil.getJavaClassName(ColumnRelationVo.getTableNameTo()) + ">",
//						CreatorUtil.getJavaVarName(ColumnRelationVo.getTableNameTo()) + "List"
//				));
//			}else{
//				poClass.addField(new Field(
//						CreatorUtil.getJavaClassName(ColumnRelationVo.getTableNameTo())));
//				containtFk=true;
//			}
//		}
//
...
//						"this." + CreatorUtil.getJavaVarName(columnList.get(i).getColumnName()) +
//								" = " + CreatorUtil.getJavaVarName(table.getTableName())+".get"
//								+CreatorUtil.getJavaClassName(columnList.get(i).getColumnName())+"();");
//			}
//			for (ColumnRelationVo ColumnRelationVo : relationList) {
//				if(2!=ColumnRelationVo.getType()){
//					constructor.addCodeLn(
//							"this." + CreatorUtil.getJavaVarName(ColumnRelationVo.getTableNameTo()) +
//									" = " + CreatorUtil.getJavaVarName(ColumnRelationVo.getTableNameTo())+";");
//				}
//			}
//		}
//
...
//		String s="";
//		for (int i = 0; i < columnList.size(); i++) {
//			s+=Constant.column2ObjectType.get(columnList.get(i).getColumnType())+" "+CreatorUtil.getJavaVarName(columnList.get(i).getColumnName());
//
