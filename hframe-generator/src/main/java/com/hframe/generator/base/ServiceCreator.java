...
////			sb.append("public class "+CreatorUtil.getJavaClassName(table.getTableName())+"Serv {/n/n");
//		//注入对应的DAO
...
////
////		//引入该表对应的dao，vo对象
////		String poPath=serviceFileName.substring(serviceFileName.indexOf("/src/")+5,serviceFileName.lastIndexOf("/service/")).replace("/", ".")+".po."+CreatorUtil.getJavaClassName(coreSet.getCoreSetName());
...
////
////		sb.append("@Component/n");
////		sb.append("public class "+CreatorUtil.getJavaClassName(coreSet.getCoreSetName())+"Serv {/n/n");
////
////		//注入对应的DAO
////		for (Table table : coreTableList) {
////			sb.append(CreatorUtil.injectBean(table.getTableName(),"DAO"));
...
////
////			String serviceName=CreatorUtil.getJavaClassName(coreSet.getCoreSetName());
////			//获得table对应serv文件的名称
...
////					sql.append(CreatorUtil.getJavaVarName(table.getTableName())+"."+CreatorUtil.getJavaVarName(coreTableColumn.getColumnName())+",");
////				}
////			}
////		}
...
////		for (Table table : tableList) {
////			List<Column> tableColumnList = table.getColumnList();
////			sql.append(CreatorUtil.getJavaClassName(table.getTableName())+" "+CreatorUtil.getJavaVarName(table.getTableName())+",");
////		}
////		sql.substring(0,sql.length()-1);
////
...
////		inputParam.put("ClassName", CreatorUtil.getJavaClassName(tableList.get(0).getTableName()));
////		inputParam.put("VarName", CreatorUtil.getJavaVarName(tableList.get(0).getTableName()));
////		inputParam.put("VOClassName", CreatorUtil.getJavaClassName(coreSet.getCoreSetName()));
////		inputParam.put("VOVarName", CreatorUtil.getJavaVarName(coreSet.getCoreSetName()));
////		inputParam.put("sqlAheadPart", sqlAheadPart);
////		inputParam.put("PkColumnName", CreatorUtil.getJavaVarName(tableList.get(0).getColumnList().get(0).getColumnName()));
////
////		//获取findAll方法
...
////		for (CoreTableColumnRelationVo coreTableColumnRelationVo : relationList) {
////
////			inputParam.put("ClassName", CreatorUtil.getJavaClassName(table.getTableName()));
////			inputParam.put("VarName", CreatorUtil.getJavaVarName(table.getTableName()));
////			inputParam.put("FkClassName", CreatorUtil.getJavaClassName(coreTableColumnRelationVo.getColumnName()));
////			inputParam.put("FkVarName", CreatorUtil.getJavaVarName(coreTableColumnRelationVo.getColumnName()));
////
...
////
////		sb.append("  public void create("+CreatorUtil.getJavaClassName(coreSet.getCoreSetName())+" "+CreatorUtil.getJavaVarName(coreSet.getCoreSetName())+"){/n/n");
////		sb.append("    try{/n");
////
////		List<Table> tableList=coreSet.getCoreTableList();
////		for (Table table : tableList) {
////			sb.append("      "+CreatorUtil.getJavaClassName(table.getTableName())+" "+CreatorUtil.getJavaVarName(table.getTableName())+" = new "+CreatorUtil.getJavaClassName(table.getTableName())+"();/n");
////		}
////		for (Table table : tableList) {
////			List<Column> columnList=table.getColumnList();
////			for (Column coreTableColumn : columnList) {
////				if(coreSetContainsStr(coreSet,coreTableColumn)){
////					sb.append("      "+CreatorUtil.getJavaVarName(table.getTableName())+".set"+CreatorUtil.getJavaClassName(coreTableColumn.getColumnName())+"("+CreatorUtil.getJavaVarName(coreSet.getCoreSetName())+".get"+CreatorUtil.getJavaClassName(coreTableColumn.getColumnName())+"());"+"/n");
////				}
////			}
////		}
////
////		for (Table table : tableList) {
////			sb.append("      "+CreatorUtil.getJavaVarName(table.getTableName())+Type+" .saveOrUpdate("+CreatorUtil.getJavaVarName(table.getTableName())+");/n");
////		}
////
////
...
////
////
////		sb.append("  public void batchCreate("+CreatorUtil.getJavaClassName(coreSet.getCoreSetName())+"[] "+CreatorUtil.getJavaVarName(coreSet.getCoreSetName())+"s){/n/n");
////		sb.append("    try{/n");
////		for (Table table : tableList) {
////			sb.append("      "+CreatorUtil.getJavaClassName(table.getTableName())+"[] "+CreatorUtil.getJavaVarName(table.getTableName())+"s = new "+CreatorUtil.getJavaClassName(table.getTableName())+"["+CreatorUtil.getJavaVarName(coreSet.getCoreSetName())+"s.length];/n");
////		}
////		sb.append("      for(int i=0;i<"+CreatorUtil.getJavaVarName(coreSet.getCoreSetName())+"s.length;i++){/n");
////
//////		for (Table table : tableList) {
//////			sb.append("      "+CreatorUtil.getJavaClassName(table.getTableName())+" "+CreatorUtil.getJavaVarName(table.getTableName())+" = new "+CreatorUtil.getJavaClassName(table.getTableName())+"();/n");
//////		}
...
////			for (Column coreTableColumn : columnList) {
////				if(coreSetContainsStr(coreSet,coreTableColumn)){
////					sb.append("          "+CreatorUtil.getJavaVarName(table.getTableName())+"s[i].set"+CreatorUtil.getJavaClassName(coreTableColumn.getColumnName())+"("+CreatorUtil.getJavaVarName(coreSet.getCoreSetName())+"s[i].get"+CreatorUtil.getJavaClassName(coreTableColumn.getColumnName())+"());"+"/n");
////				}
////			}
////		}
////		sb.append("      }/n");
////		for (Table table : tableList) {
////			sb.append("      "+CreatorUtil.getJavaVarName(table.getTableName())+Type+" .batchSave("+CreatorUtil.getJavaVarName(table.getTableName())+"s);/n");
////		}
////		sb.append("    } catch (Exception e) {/n");
////		sb.append("      e.printStackTrace();/n");
////		sb.append("    }/n/n");
...
////
////
////		//sb.append("  public void batchCreate(List<"+CreatorUtil.getJavaClassName(tableName)+"> "+CreatorUtil.getJavaVarName(tableName)+"s){/n/n");
////		sb.append("  public void batchCreate(List "+CreatorUtil.getJavaVarName(coreSet.getCoreSetName())+"s){/n/n");
////		sb.append("     batchCreate(("+CreatorUtil.getJavaClassName(coreSet.getCoreSetName())+"[])"+CreatorUtil.getJavaVarName(coreSet.getCoreSetName())+"s.toArray(new "+CreatorUtil.getJavaClassName(coreSet.getCoreSetName())+"[0])"+");/n/n");
////		sb.append("  }/n/n");
////
////
////
////		sb.append("  public void update("+CreatorUtil.getJavaClassName(coreSet.getCoreSetName())+" "+CreatorUtil.getJavaVarName(coreSet.getCoreSetName())+"){/n/n");
////		sb.append("    try{/n");
////		for (Table table : tableList) {
////			sb.append("      "+CreatorUtil.getJavaClassName(table.getTableName())+" "+CreatorUtil.getJavaVarName(table.getTableName())+" = new "+CreatorUtil.getJavaClassName(table.getTableName())+"();/n");
////		}
...
////
////		for (Table table : tableList) {
////			sb.append("      "+CreatorUtil.getJavaVarName(table.getTableName())+Type+" .update("+CreatorUtil.getJavaVarName(table.getTableName())+");/n");
////		}
////		sb.append("    } catch (Exception e) {/n");
////		sb.append("      e.printStackTrace();/n");
////		sb.append("    }/n/n");
////		sb.append("  }/n/n");
////
////		sb.append("  public void delete("+CreatorUtil.getJavaClassName(coreSet.getCoreSetName())+" "+CreatorUtil.getJavaVarName(coreSet.getCoreSetName())+"){/n/n");
////		sb.append("    try{/n");
////		for (Table table : tableList) {
////			sb.append("      "+CreatorUtil.getJavaClassName(table.getTableName())+" "+CreatorUtil.getJavaVarName(table.getTableName())+" = new "+CreatorUtil.getJavaClassName(table.getTableName())+"();/n");
////		}
...
////
////		for (Table table : tableList) {
////			sb.append("      "+CreatorUtil.getJavaVarName(table.getTableName())+Type+" .delete("+CreatorUtil.getJavaVarName(table.getTableName())+");/n");
////		}
////		sb.append("    } catch (Exception e) {/n");
////		sb.append("      e.printStackTrace();/n");
////		sb.append("    }/n/n");
...
////		sb.append("    try{/n");
////		for (Table table : tableList) {
////			sb.append("      "+CreatorUtil.getJavaVarName(table.getTableName())+Type+" .delete(id);/n");
////		}
////		sb.append("    } catch (Exception e) {/n");
////		sb.append("      e.printStackTrace();/n");
////		sb.append("    }/n/n");
