...
public abstract class AbstractGenerator {
    ...
    public AbstractGenerator(String companyName, String projectName, String moduleName, Table table) throws Exception {
        ...
        this.table = table;
        CreatorContainer container = CreatorUtil.getCreatorContainer(companyName, projectName, moduleName, table.getTableName());
    ...
    public  String create() throws Exception {
        ...
        String content = VelocityUtil.produceTemplateContent("com/hframe/generator/vm/po.vm", map);
