...
//        upload("10.20.69.80", 21, "test", "test", new File("D:/ftp/test.txt"), "/ucfpay/pay", "test.txt");
        download("10.20.69.80", 21, "test", "test","/ucfpay/pay", "20160105-Pay-M100000000.txt","D:/ftp");
