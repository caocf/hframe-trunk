...
create table hfmd_enum(
   hfmd_enum_id bigint(20) primary key auto_increment comment '枚举ID',
...
create table hfpm_page_event(
   hfpm_page_event_id bigint(20) primary key auto_increment comment '页面事件ID',
   ...
   hfpm_page_component_id bigint(20) comment '页面组件ID') comment '页面事件';
...
create table hfmd_entity(
   ...
   hfmd_entity_name varchar(64) comment '实体名称',
   hfmd_entity_code varchar(64) comment '实体编码',
...
create table hfmd_entity_attr(
   ...
   hfmd_entity_attr_name varchar(64) comment '实体属性名称',
   hfmd_entity_attr_code varchar(64) comment '实体属性编码',
   hfmd_entity_attr_desc varchar(128) comment '实体属性描述',
   attr_type int(2) comment '属性类型',
   size varchar(6) comment '大小',
   ispk int(2) comment '是否主键',
   nullable int(2) comment '是否为空',
   is_busi_attr int(2) comment '是否业务属性',
